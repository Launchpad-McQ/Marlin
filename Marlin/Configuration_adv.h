...
#define MECHANICAL_GANTRY_CALIBRATION
  ...
  #define GANTRY_CALIBRATION_EXTRA_HEIGHT      18     // Extra distance in mm past Z_###_POS to move
  #define GANTRY_CALIBRATION_FEEDRATE         500     // Feedrate for correction move
  #define GANTRY_CALIBRATION_TO_MIN                 // Enable to calibrate Z in the MIN direction

  #define GANTRY_CALIBRATION_SAFE_POSITION  { 0, 420 } // Safe position for nozzle
  #define GANTRY_CALIBRATION_XY_PARK_FEEDRATE 6000  // XY Park Feedrate - MMM
